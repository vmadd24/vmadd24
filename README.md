...
- Monitoring, observability, reliability, and test automation
...
Airflow + Docker + PostgreSQL + YouTube API with SODA data quality checks and Pytest automation.

### 🏗 **Construction Company Management System**  
🔗 https://github.com/vmadd24/Construction-Company-Management-System  
Java + PostgreSQL system for project tracking, resource management, and employee management.
